                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input 
                            ...
                            name="remember" 
                            type="checkbox" 
                            class="h-4 w-4 text-bank-600 focus:ring-bank-500 border-gray-300 rounded"
                        >
                ...
                <div>
                    ...
                    >
                        <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                            <i class="fas fa-sign-in-alt text-bank-500 group-hover:text-bank-400"></i>
                        </span>
                        Masuk
                    </button>
                </div>
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        Belum punya akun? 
                        <a href="{{ route('register') }}" class="font-medium text-bank-600 hover:text-bank-500 transition duration-200">
                            Daftar sekarang
                        </a>
                    </p>
                </div>
